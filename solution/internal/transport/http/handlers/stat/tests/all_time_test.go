...
func TestGetByCmampaign(t *testing.T) {
	t.Parallel()
	...
	tests := []struct {
	...
	}{
		{
			...
			statServiceMock: func(mc *minimock.Controller) service.StatService {
				...
				mock.GetByCampaignMock.Expect(ctx, campaignID).Return(&serviceResp, nil)
				return mock
			},
		},
		{
			...
			statServiceMock: func(mc *minimock.Controller) service.StatService {
				mock := mocks.NewStatServiceMock(mc)
				mock.GetByCampaignMock.Expect(ctx, campaignID).Return(nil, campaign.ErrCampaignNotFound)
				return mock
			},
		},
	}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			middleware.ErrorHandlerMiddleware(handler.GetByCampaign())(c)
...
func TestGetByAdvertiser(t *testing.T) {
	t.Parallel()
	type statServiceMockFunc func(mc *minimock.Controller) service.StatService
	...
	tests := []struct {
	...
	}{
		{
			...
			statServiceMock: func(mc *minimock.Controller) service.StatService {
				mock := mocks.NewStatServiceMock(mc)
				mock.GetByAdvertiserMock.Expect(ctx, advertiserID).Return(&serviceResp, nil)
				return mock
			},
		},
		{
			...
			statServiceMock: func(mc *minimock.Controller) service.StatService {
				mock := mocks.NewStatServiceMock(mc)
				mock.GetByAdvertiserMock.Expect(ctx, advertiserID).Return(nil, advertiser.ErrAdvertiserNotFound)
				return mock
			},
		},
	}
	...
	for _, tt := range tests {
		...
		t.Run(tt.name, func(t *testing.T) {
			...
			middleware.ErrorHandlerMiddleware(handler.GetByAdvertiser())(c)
